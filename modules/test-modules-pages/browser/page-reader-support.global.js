(function (window) {
  ...
  function resolvePageApplicationRuntime(targetGlobal) {
    return targetGlobal.__CRUD_PAGE_APPLICATION_RUNTIME__ || null;
  }

  function buildReaderNavigationRuntimeAugment(contract, apiOrigin, targetGlobal) {
    var readerRuntime = resolvePageApplicationRuntime(targetGlobal);
    if (
      !readerRuntime ||
      typeof readerRuntime.fetchReaderBootstrap !== "function" ||
      typeof readerRuntime.fetchReaderDeferred !== "function"
    ) {
      return {};
    }
      ...
      queries: [
        {
          ...
          executeRemote: async function (input) {
            var request = input && input.request ? input.request : {};
            var params = request.params && typeof request.params === "object" ? request.params : {};
            return readerRuntime.fetchReaderBootstrap(
              targetGlobal,
              contract,
              apiOrigin,
              params.path || "/"
        ...
        },
        {
          ...
          executeRemote: async function (input) {
            var request = input && input.request ? input.request : {};
            var params = request.params && typeof request.params === "object" ? request.params : {};
            return readerRuntime.fetchReaderDeferred(
              targetGlobal,
              contract,
              apiOrigin,
              params.path || "/"
