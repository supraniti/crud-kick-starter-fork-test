  ...
  switch (normalizeTargetKind(targetKind)) {
    ...
    case "browser-delivery":
      return {
        ...
        publicCommentsCollectionPath: null,
        dnsZone: null,
        certificateName: null,
        urlMapHint: null,
...
function normalizeBrowserOnlyTargetConfig(config, defaults) {
  const browserDeliveryConfig = normalizeBrowserDeliveryConfig({
    ...
    applicationApiOrigin: pickConfigValue(config, defaults, "applicationApiOrigin"),
    firebaseProjectId: pickConfigValue(config, defaults, "firebaseProjectId"),
    firebaseApiKey: pickConfigValue(config, defaults, "firebaseApiKey"),
    firebaseAppId: pickConfigValue(config, defaults, "firebaseAppId"),
    firebaseAuthDomain: pickConfigValue(config, defaults, "firebaseAuthDomain"),
    firebaseStorageBucket: pickConfigValue(config, defaults, "firebaseStorageBucket"),
    firebaseMessagingSenderId: pickConfigValue(config, defaults, "firebaseMessagingSenderId"),
    firebaseMeasurementId: pickConfigValue(config, defaults, "firebaseMeasurementId"),
    publicCommentsCollectionPath: pickConfigValue(config, defaults, "publicCommentsCollectionPath"),
  ...
  return {
    ...
    applicationApiOrigin: browserDeliveryConfig.applicationApiOrigin,
    firebaseProjectId: browserDeliveryConfig.firebaseProjectId,
    firebaseApiKey: browserDeliveryConfig.firebaseApiKey,
    firebaseAppId: browserDeliveryConfig.firebaseAppId,
    firebaseAuthDomain: browserDeliveryConfig.firebaseAuthDomain,
    firebaseStorageBucket: browserDeliveryConfig.firebaseStorageBucket,
    firebaseMessagingSenderId: browserDeliveryConfig.firebaseMessagingSenderId,
    firebaseMeasurementId: browserDeliveryConfig.firebaseMeasurementId,
    publicCommentsCollectionPath: browserDeliveryConfig.publicCommentsCollectionPath,
