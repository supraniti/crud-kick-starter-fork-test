...
export function createReleaseStepPlan(includeBrowserValidation = false) {
  const steps = [
...
export function createBundleRunCreatePayload({
  bundle,
  page,
  steps,
  startedOn
...
export function markRunStep(steps, stepKey, status, message, finishedOn) {
...
export function createBundleRunUpdatePayload({
  previousRun,
  steps,
  status,
  summaryMessage,
